    ...
    questions:
        [
            ...
            },
            {
                ...
                answer:         `MCP stands for "Model-Context-Prompt" and is a framework used in AI, particularly in natural language processing (NLP) tasks. It involves three components:
                                <ul class="list-items">
                                    <li><span class="font-medium">Model:</span> The underlying AI model that processes the input and generates output. This could be a language model like GPT-3 or a custom-trained model for specific tasks.</li>
                                    <li><span class="font-medium">Context:</span> The information or data that provides background or situational awareness to the model. This can include previous interactions, user preferences, or any relevant data that helps the model understand the current task.</li>
                                    <li><span class="font-medium">Prompt:</span> The specific input or query given to the model to elicit a response. The prompt is designed to guide the model in generating the desired output based on the provided context.</li>
                                </ul>`
            },
        ]
}
